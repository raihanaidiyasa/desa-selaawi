      ...
      <div class="card w-100">
        <div class="card-header bg-primary">
            <div class="row align-items-center">
                <div class="col-6">
                    <h5 class="card-title fw-semibold text-white">Tambah Data Lembaga Pendidikan</h5>
                </div>
        ...
        <div class="card-body">
            {{-- Form action disesuaikan untuk route store lembaga pendidikan --}}
            <form method="POST" action="/admin/lembaga-pendidikan">
                @csrf
                <div class="mb-3">
                    {{-- Input untuk 'lembaga' --}}
                    <label for="lembaga" class="form-label">Nama Lembaga <span style="color: red">*</span></label>
                    <input type="text" class="form-control" name="lembaga" id="lembaga" value="{{ old('lembaga') }}">
                    @error('lembaga')
