      ...
      <div class="card w-100">
        <div class="card-header bg-primary">
            <div class="row align-items-center">
                <div class="col-6">
                    <h5 class="card-title fw-semibold text-white">Tambah Data Hasil Pertanian</h5>
                </div>
        ...
        <div class="card-body">
            <form method="POST" action="/admin/hasil-pertanian">
                @csrf
                <div class="mb-3">
                    <label for="jenis" class="form-label">Jenis Tanaman <span style="color: red">*</span></label>
                    <input type="text" class="form-control" name="jenis" id="jenis" value="{{ old('jenis') }}">
                    @error('jenis')
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="any" class="form-control" name="luas" id="luas" value="{{ old('luas') }}">
                    @error('luas')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="number" step="any" class="form-control" name="hasil" id="hasil" value="{{ old('hasil') }}">
                    @error('hasil')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
